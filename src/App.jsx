  ...
  const awardCrystals = () => {
    ...
    if (crystalsChanged) {
      ...
      if (currentUser && myNewCrystals.length > myOldCrystals.length) {
        ...
        if (newCrystal) {
          const crystalEmoji = newCrystal.category === 'Mind' ? '🔵' : newCrystal.category === 'Body' ? '🔴' : '🟡';
            ...
            {habitBoardMode === 'custom' && getPendingApprovals().length > 0 && (
              <div className="bg-yellow-50 border-2 border-yellow-400 rounded-2xl shadow-lg p-6">
                <h2 className="text-xl font-bold text-yellow-900 mb-4 flex items-center">
                  ⚠️ Pending Approvals ({getPendingApprovals().length})
                </h2>
                      ...
                      <div key={habit.id} className="bg-white p-4 rounded-lg border-2 border-yellow-300">
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-600">{habit.category} • {habit.points} shards</p>
                            <p className="text-xs text-gray-500 mt-1">
                              Created by: {creator?.username || 'Unknown'}
                              {habit.isRepeatable && ` • Repeatable (max: ${habit.maxCompletions})`}
                            </p>
                          </div>
                ...
                <p className="text-sm text-yellow-800 mt-4">
                  💡 Review these habits to ensure fair competition. Approve habits that seem reasonable, reject ones that seem unfair.
                </p>
              </div>
            )}
                ...
                {newHabit.name && (
                  <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                    ...
                    <p className="text-gray-800">
                      <strong>{newHabit.name}</strong> • {newHabit.category} • {newHabit.points} shards
                      {newHabit.isRepeatable && ` • Repeatable (max: ${newHabit.maxCompletions}x)`}
                    </p>
                  </div>
                )}
                              ...
                              <div className="flex items-center flex-1">
                                ...
                                <div>
                                  ...
                                  <p className="text-sm text-gray-600">
                                    {habit.points || 0} shards {habit.isRepeatable && count > 0 && `× ${count}`}
            ...
            <div className="bg-gradient-to-br from-yellow-400 to-orange-400 rounded-2xl shadow-lg p-6 text-gray-900">
              ...
              <div className="space-y-4">
                <div className="bg-white bg-opacity-30 rounded-lg p-4">
                  ...
                  <p className="text-5xl font-bold">{myWeekCrystals} 💎</p>
                </div>
                <div className="bg-white bg-opacity-20 rounded-lg p-3">
                  <p className="text-xs font-semibold mb-1">All-Time</p>
                  <p className="text-2xl font-bold">{myAllTimeCrystals} 💎</p>
                </div>
                <div className="bg-white bg-opacity-20 rounded-lg p-3">
                  <p className="text-xs font-semibold mb-1">Weekly Wins</p>
                  <p className="text-2xl font-bold">🏆 {myWeeklyWins}</p>
                </div>
              </div>
            </div>
                  ...
                  {weeklyLeaderboard.map((user, index) => (
                    ...
                    >
                      ...
                      <div className="text-right">
                        <p className="font-bold text-blue-600 text-lg">{user.crystals} 💎</p>
              ...
              <div className="space-y-6">
                <div className="bg-blue-50 p-6 rounded-xl">
                  ...
                  <ol className="space-y-2 text-gray-700">
                    <li><strong>1.</strong> Complete habits to earn <strong>shards</strong> in three categories: Mind 🧠, Body 💪, and Spirit ✨</li>
                    <li><strong>2.</strong> Win a <strong>crystal 💎</strong> by having the most shards in a category each day</li>
                ...
                <div className="bg-green-50 p-6 rounded-xl">
                  <h3 className="text-xl font-bold text-green-900 mb-3">Perfect Day ✨</h3>
                  <p className="text-gray-700">
                    ...
                    {getCurrentWeekWinner() ? (
                      <div>
                        ...
                        <p className="text-sm opacity-90">
                          {getWeekCrystals(getCurrentWeekWinner().id)} crystals • {getWeekPoints(getCurrentWeekWinner().id)} shards
                        </p>
                      </div>
                    ) : (
                          ...
                          <div className="flex items-center justify-between">
                            <div>
                              <p className="font-bold text-gray-900">
                                {index === 0 ? '🏆' : `${index + 1}.`} {record.winnerName}
                              </p>
                              <p className="text-sm text-gray-600">
                                Week ending {new Date(record.weekEnding).toLocaleDateString()} • {record.crystals} crystals
                              </p>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              <div className="p-6">
                ...
                <div className="space-y-6">
                  <section>
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">💎 Crystal System Explained</h3>
                    ...
                    <div className="space-y-2 text-gray-700">
                      <p><strong>🔵 Mind Crystal:</strong> Most shards in Mind category (studying, learning, reading)</p>
                      <p><strong>🔴 Body Crystal:</strong> Most shards in Body category (exercise, nutrition, sleep)</p>
                      <p><strong>🟡 Spirit Crystal:</strong> Most shards in Spirit category (meditation, journaling, digital detox)</p>
                      <p><strong>⚠️ Ties:</strong> If you tie in a category, NO ONE gets that crystal. Push harder to avoid ties!</p>
                      <p><strong>✨ Perfect Day:</strong> Win all 3 crystals in one day for ultimate bragging rights!</p>
                    </div>
                  </section>

                  <section>
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">🏆 How to Win</h3>
                  ...
                  <section>
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">📊 Tracking Your Progress</h3>
                    <p className="text-gray-700 mb-2">
                    ...
                    <p className="text-gray-700">
                      <strong>Weekly Wins:</strong> How many weeks you've been the champion 🏆
                    </p>
                  </section>

                  <section>
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">✅ Completing Habits</h3>
                    <ul className="text-gray-700 space-y-2">
                      <li><strong>+ Button (Green):</strong> Click to complete a habit or add another completion</li>
                      <li><strong>− Button (Red):</strong> Click to subtract a completion if you made a mistake</li>
                  ...
                  <section>
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">⚡ What are Shards?</h3>
                    <p className="text-gray-700">
                  ...
                  <section>
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">➕ Adding Custom Habits</h3>
                    <p className="text-gray-700">
                  ...
                  <section>
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">🔄 Managing Habits</h3>
                    <ul className="text-gray-700 space-y-2">
                  ...
                  <section>
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">🏆 Competition Features</h3>
                    <p className="text-gray-700">
                  ...
                  <section>
                    ...
                    <ul className="text-gray-700 space-y-1">
                      <li>• Balance all three categories to maximize crystal collection</li>
                      <li>• Check off habits throughout the day, not just at the end</li>
                      <li>• Focus on consistency - collect crystals every day to win the week</li>
                      <li>• Use the crystal awards section to see which categories need more focus</li>
                      <li>• A "Perfect Day" (all 3 crystals) is worth more than dominating one category</li>
                    </ul>
                  </section>

                  <section>
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">🎯 Habit Board Modes</h3>
